...
const features = [
  ...
  { name: "Auto-Apply*", free: false, premium: true },
    ...
    <MainLayout>
      <div className="min-h-screen  flex flex-col items-center text-gray-800">
        ...
        <section className="w-full home-gradient text-white py-16 px-6 text-center pt-[100px] sm:pt-[180px] ">
          <div className="flex gap-12 max-w-6xl mx-auto align-baseline flex-col md:flex-row items-center">
            <div className="flex-[1.5] text-center">
              ...
              <Button
                className="bg-white text-gray-800 font-semibold rounded-lg shadow hover:bg-gray-100 transition-all px-9 py-4 text-lg"
            ...
            {/* <div className="flex-1 w-full">
                ...
                <div className="relative">
                    ...
                    <div className="absolute inset-0 blur-3xl bg-indigo-600/20 rounded-3xl drop-shadow-[0_10px_25px_rgba(0,0,0,0.6)]"></div>
                </div>
                
            </div> */}
            <img src="/resume-hero-final.png" width={500} className="relative z-10" />
          </div>
        </section>
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 items-center">
                    ...
                    <div className="bg-white shadow-md rounded-xl p-5 flex items-center justify-center hover:shadow-xl transition-all border border-gray-100">
                        <SiAdobe className="text-red-600 w-8 h-8" />
                    </div>

                    <div className="bg-white shadow-md rounded-xl p-5 flex items-center justify-center hover:shadow-xl transition-all border border-gray-100">
                        <SiAmazon className="text-blue-600 w-8 h-8" />
                    </div>
        ...
        <div className="relative z-10 text-center">
            ...
            <button className="bg-white text-indigo-700 font-semibold px-8 py-4 rounded-xl shadow-lg hover:bg-gray-100 transition-all hover:shadow-xl text-lg" 
            onClick={() => {
              if (typeof window !== "undefined" && window.gtag) {
        ...
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,115,0,0.2),transparent)]"></div>
        </footer>
