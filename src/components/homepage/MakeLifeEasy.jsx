    ...
    <section className="bg-gradient-to-b from-gray-900 via-gray-800 to-black py-20 text-white relative overflow-hidden">
      ...
      <div className="container relative z-10 text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-300 mb-8">
          Join 5000+ job seekers who have transformed their careers with{" "}
          <span className="text-brand-gold font-semibold">WisOwl AI</span>
        </p>
        ...
        <div className="max-w-xl mx-auto mt-10 space-y-5 text-left">
          <div className="flex items-start gap-3">
            ...
            <p className="text-lg">
              Get matched with 3-5 perfect jobs in your first week
            </p>
          </div>
