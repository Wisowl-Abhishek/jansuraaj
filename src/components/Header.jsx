...
const Header = () => {
  ...
  return (
    <header
      id="header_navbar"
      className={`fixed top-4 sm:top-6 right-4 sm:right-6 z-30 flex items-center gap-1.5 sm:gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-full bg-black/20 backdrop-blur shadow-md ${shimmerButtonClass}`}
    >
