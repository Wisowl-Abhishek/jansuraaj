...
export default function HowItWorksPage() {
  const appUrl = process.env.NEXT_PUBLIC_APP_URL ? (process.env.NEXT_PUBLIC_APP_URL.endsWith('/') ? process.env.NEXT_PUBLIC_APP_URL : `${process.env.NEXT_PUBLIC_APP_URL}/`) : "https://app.wisowl.com/";
